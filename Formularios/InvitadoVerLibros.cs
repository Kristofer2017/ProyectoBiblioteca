...
{
    public partial class InvitadoVerLibros : Form
    {
        public InvitadoVerLibros()
        {
            InitializeComponent();
        }

        Transacciones t = new Transacciones();
        LibrosUnion libro = new LibrosUnion();
        ...
        private void InvitadoVerLibros_Load(object sender, EventArgs e)
        {
            actualizarDGV();
